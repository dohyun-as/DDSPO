        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                ...
                if not args.train_text_encoder:
                    ...
                    neg_prompt_embeds, neg_pooled_prompt_embeds = compute_text_embeddings(
                    ...
                    neg_tokens_one = tokenize_prompt(tokenizer_one, prompts)
                    neg_tokens_two = tokenize_prompt(tokenizer_two, prompts)
                    neg_tokens_three = tokenize_prompt(tokenizer_three, prompts)
