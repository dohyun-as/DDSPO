        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                if args.sdxl:
                    ...
                    pos_neg_encoder_hidden_states = torch.cat([encoder_hidden_states, neg_encoder_hidden_states], dim=0)
                ...
                ref_pos_neg_args = (noisy_latents.repeat(2,1,1,1),
                                    timesteps.repeat(2), 
                ...
                if args.train_method == 'sft': # SFT, casting for F.mse_loss
                    ...
                    model_losses = (model_pred.repeat(2,1,1,1) - target).abs().mean(dim=[1,2,3])
