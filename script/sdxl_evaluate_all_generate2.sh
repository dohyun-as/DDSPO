...
RESULT_PATHS=(
    "./results/SDXL/ours_beta16k_loss_weighiting_linear/checkpoint-100"
    "./results/SDXL/ours_beta16k_loss_weighiting_linear/checkpoint-200"
    "./results/SDXL/ours_beta16k_loss_weighiting_linear/checkpoint-300"
    "./results/SDXL/ours_beta16k_loss_weighiting_linear/checkpoint-400"
    "./results/SDXL/ours_beta16k_loss_weighiting_linear/checkpoint-500"
)
