...
RESULT_PATHS=(
    "./results/SDXL/ours_beta10k/checkpoint-100"
    "./results/SDXL/ours_beta10k/checkpoint-200"
    "./results/SDXL/ours_beta10k/checkpoint-300"
    "./results/SDXL/ours_beta10k/checkpoint-400"
    "./results/SDXL/ours_beta10k/checkpoint-500"
)
